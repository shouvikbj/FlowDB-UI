    ...
    <div className="bg-gray-100 min-h-screen font-sans">
      ...
      <main className="container mx-auto py-12">
        ...
        <section className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-4 text-slate-500">Key Features</h2>
        ...
        <section className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-4 text-slate-500">What Our Clients Say</h2>
        ...
        <section className="text-center">
          <h2 className="text-4xl font-bold mb-4 text-slate-500">Get Started Today</h2>
          <p className="text-gray-700">
